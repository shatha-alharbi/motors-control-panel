...
<body style=" background-image:url(background-image.png);">
  <h1 style="    margin-left:35%;border: none;padding: 14px 28px; font-size: 24px; color: white; " >MOTORS CONTROL PANEL</h1>
...
<div class="slidecontainer">
 ...
 <p>Motor 2<input type="range" min="1" max="180" value="90" class="slider" id="myRange2"name="slider2">  Value:<label> <span id="demo2"></span></label></p>
